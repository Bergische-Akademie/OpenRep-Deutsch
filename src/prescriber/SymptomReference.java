...
/** Contains all the information about the crossreferences to a specific symptom
 *
 * @author vladimir
 */
public class SymptomReference {
   /** unique id of an symptom */
   public int id;
   /** list of all the references to this symptom */
